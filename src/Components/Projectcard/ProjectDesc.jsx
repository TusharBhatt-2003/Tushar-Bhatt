  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs mb-4 inverted-selection">{description}</p>
        <p className="text-xs inverted-selection">
          <strong className="inverted-selection">Technologies: </strong> {technologies}
        </p>
        <a href={github} className="font-extrabold inverted-selection">
          Code
        </a>
        <p className="text-xs mt-2 uppercase inverted-selection">{category}</p>
      </div>
    </motion.div>
  );
};
