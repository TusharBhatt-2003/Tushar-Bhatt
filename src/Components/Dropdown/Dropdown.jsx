...
function Dropdown() {
  ...
  const handleClick = (id) => {
    ...
    setDropdownToggled(false); // Close dropdown on item click
  };
  ...
  return (
    <div className="md:hidden flex justify-center items-center drop-shadow-2xl">
      ...
      {dropdownToggled && ( // Conditionally render the menu items
        <div
          className="dropdown-menu absolute -right-3 top-16 flex justify-center text-center flex-col-reverse rounded-xl drop-shadow-2xl border-2"
