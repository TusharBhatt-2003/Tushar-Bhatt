...
const Hero = ({ currentLanguage, translations, letterRefs, handleColorChange, showHint, setShowHint, textColor }) => {
  return (
<>
<div className="md:ml-10 w-fit lg:w-full flex flex-col justify-center lg:items-start items-center">
      ...
      <p className="text-xl lg:text-3xl font-light drop-shadow-2xl">A Frontend Developer</p>
    </div>
