...
const Projects = () => {
  ...
  return (
    <div
      ...
      id="projects"
      className="projectContainer border-4 rounded-3xl container mx-auto overflow-hidden p-5 h-fit lg:h-screen lg:px-10 flex lg:flex-row flex-col lg:justify-between items-center uppercase font-['Aero']"
      style={{
        backgroundColor: activeFilteredPageBGcolor,
        borderColor: activeFilteredBgColor,
